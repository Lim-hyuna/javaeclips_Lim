...
public class HomeController {
	...
	public ModelAndView home(ModelAndView mv){
		//memberService.SendEmail("메일 테스트", "내용", "sngzunlove@naver.com");
	...
	public ModelAndView loginGet(ModelAndView mv, HttpServletRequest request){
		...
		//System.out.println(url); //http://localhost:8080/spring/board/select/15
	...
	public ModelAndView logoutGet(ModelAndView mv, HttpSession sesson){
		sesson.removeAttribute("user");
	    mv.setViewName("redirect:/");
	    return mv;
	}
	@RequestMapping(value ="/test")
	@ResponseBody  //리턴한 값을 화면에 그대로 전달함
	...
	public Map<Object, Object> findPw(@RequestBody MemberVo member){
		HashMap<Object, Object> map = new HashMap<Object, Object>();
		//System.out.println(member);
		//memberService.SendEmail("제목", "내용", "sngzunlove@naver.com");
		boolean res = false;
